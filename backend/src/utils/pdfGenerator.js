  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .text(
          `Tel: ${invoice.v_telephone || "Not provided"} | Email: ${
            invoice.v_mail || "Not provided"
          }`,
          90,
          85
        );
      ...
      // Invoice box
      doc.fillColor(yellow).rect(450, 0, 100, 120).fill();
      ...
      doc.fontSize(12).font("NotoSans-Bold").text("BILL TO:", 50, 170);
      ...
      doc
        ...
        .text(
          formatDate(
            new Date(invoice.i_date.getTime() + 15 * 24 * 60 * 60 * 1000)
          ),
          450,
          200
        );
      ...
      // Table header
      doc.fillColor(yellow).rect(50, tableTop, tableWidth, 25).fill();

      doc.fillColor(darkOlive).fontSize(10).font("NotoSans-Bold");
      ...
      invoice.i_product_det_obj.forEach((item, index) => {
        ...
        doc
          .fillColor("black")
          .text(
            item.description || "Product description not provided",
            columns.item.x,
            tableRow + 8
          )
      ...
      doc
        ...
        .text(
          `₹${((invoice.i_total_amnt * invoice.i_tax) / 100).toFixed(2)}`,
          460,
          totalsTop + 35
        )
